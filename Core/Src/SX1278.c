...
void SX1278_enable_invertIQ(SX1278_t *module)
{
	SX1278_SPIWrite(module, 0x33, 0x66);
	SX1278_SPIWrite(module, 0x3B, 0x19);
}

void SX1278_disable_invertIQ(SX1278_t *module)
{
